...
export default async function ProjectDetails({params}: { params: Promise<{ slug: string }> }) {
    ...
    return (
        <section className='grid app-margin w-full gap-4 items-center grid--app-columns mb-12'>
            <div className='flex flex-col content mt-24 gap-8'>
                <BackButton/>
                <Card className="relative overflow-hidden bg-card/80 min-h-[320px] flex flex-col justify-end">
                    ...
                    <CardHeader className="relative">
                        ...
                        <h2 className="mt-3">{project.subtitle}</h2>
                        <p className="text-base text-neutral-300">{project.brief}</p>
                    </CardHeader>
                </Card>
